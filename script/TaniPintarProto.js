        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('camera-button') || e.target.closest('.camera-button')) {
        ...
        setInterval(() => {
            ...
            if (tempDisplay && document.getElementById('dashboard').classList.contains('active')) {
        ...
        function updateSensorData() {
            ...
            sensors.forEach((sensor, index) => {
                if (sensor.element && document.getElementById('monitoring').classList.contains('active')) {
